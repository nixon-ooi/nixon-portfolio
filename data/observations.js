const observations = [
    {
        ...
        sections: [
            ...
            },
            {
                ...
                images: [{ url: 'assets/digital-world-tools.webp', alt: 'Tools I used to develop my site' }],
            ...
            },
            {
                ...
                images: [{ url: 'assets/digital-world-style-tile.webp', alt: 'Design Style Tile' }],
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                images: [{ url: 'assets/cpf-lock.png', alt: 'CPF lock icon' }],
            ...
            },
            {
                ...
                images: [{ url: 'assets/cpf-physical-deterrence.png', alt: 'Examples of physical deterrence methods inspired by Police Force' }],
            ...
            },
            {
                ...
                images: [
                    ...
                    { url: 'assets/cpf-initial-prototype-result.png', caption: 'Test Results' }
                ]
            },
            {
                type: 'tabs',
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                images: [{ url: 'assets/banking-current-design.png', alt: 'Screengrab of current banking app design' }],
                proposals: [
                    {
            ...
            },
            {
                type: 'image-text',
                layout: 'stacked',
                images: [{ url: 'assets/banking-recommend.png', alt: 'Side by side comparison of banking app improvements' }]
            },
        ]
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                images: [{ url: 'assets/switch-sitemap.webp', alt: 'Site map provides an overview on tasks and functionality the app provides' }]
            },
            {
                type: 'gallery',
                galleryType: 'carousel',
